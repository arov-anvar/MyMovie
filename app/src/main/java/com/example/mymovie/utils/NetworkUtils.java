...
public class NetworkUtils {
    ...
    private static final String API_KEY = "ef3334fa7079fe9be09ba0d3e5ea5fb9";
    ...
    //загрузка json object для reviews из интернета
    ...
    //загрузка json object для video из интернета
    ...
    // загрузка данных и передача url через объект bundle для исключения
    // ошибок при загрузке данных при перевороте экрана
